    ...
    return (
      <div className="flex items-center justify-center h-[calc(100vh-64px)] bg-bg-base">
        <div className="flex flex-col items-center gap-4">
          ...
          <p className="text-text-main text-base font-black">
            Loading workspace…
          </p>
        </div>
      </div>
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
          <div>
            <button
              type="button"
              onClick={() => router.push("/")}
              className="mb-4 inline-flex items-center gap-2 text-sm font-black text-text-muted hover:text-text-main transition-colors"
            >
              ← Back to home
            </button>
            ...
            icon={
              ...
              >
                <path
                  ...
                  strokeLinejoin="round"
                  strokeWidth={2.5}
                  d="M3 21v-4m0 0V5a2 2 0 012-2h6.5l1 1H21l-3 6 3 6H11.5l-1-1H5a2 2 0 00-2 2zm9-13.5V9"
                />
              </svg>
            }
          />
